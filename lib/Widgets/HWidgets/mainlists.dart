...
class MainLists extends StatelessWidget {
  ...
  MainLists({this.meetersCollections, this.mainText, this.clr, this.clr1});
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: ListView.builder(
                  shrinkWrap: true,
                  itemCount: meetersCollections!.length,
                  scrollDirection: Axis.horizontal,
                  itemBuilder: (context, index) {
                    List<MeetupData> meetersCollection =
                        meetersCollections![index];
                    return ListView.builder(
                      shrinkWrap: true,
                      itemCount: meetersCollection.take(2).toList().length,
                      scrollDirection: Axis.horizontal,
                      itemBuilder: (context, index) {
                        return Padding(
                          padding: EdgeInsets.symmetric(
